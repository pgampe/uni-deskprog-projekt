...
view { radius, isRed, clicked } =
    Svg.svg [width "1500", height "1500"]
      ...
      , defs []
          [
          circle [id "cw", cx "0", cy "0", r "50", fill "white", stroke "black", strokeWidth "7"] []
          , circle [id "cy", cx "0", cy "0", r "50", fill "yellow", stroke "black", strokeWidth "7"] []
          , circle [id "cg", cx "0", cy "0", r "50", fill "green", stroke "black", strokeWidth "7"] []
          , circle [id "cr", cx "0", cy "0", r "50", fill "red", stroke "black", strokeWidth "7"] []
          , circle [id "cb", cx "0", cy "0", r "50", fill "black", stroke "black", strokeWidth "7"] []
          , circle [id "csy", cx "0", cy "0", r "40", fill "yellow", stroke "black", strokeWidth "7"] []
          , circle [id "csg", cx "0", cy "0", r "40", fill "green", stroke "black", strokeWidth "7"] []
          , circle [id "csr", cx "0", cy "0", r "40", fill "red", stroke "black", strokeWidth "7"] []
          , circle [id "csb", cx "0", cy "0", r "40", fill "black", stroke "black", strokeWidth "7"] []
      ...
      , use [x "625", y "125", xlinkHref "#cw"] []
       , use [x "675", y "125", xlinkHref "#lh"] []
       , use [x "750", y "125", xlinkHref "#cw"] []
       , use [x "800", y "125", xlinkHref "#lh"] []
       , use [x "875", y "125", xlinkHref "#cg"] []

       , use [x "625", y "175", xlinkHref "#lv"] []
       , use [x "875", y "175", xlinkHref "#lv"] []
       , use [x "625", y "250", xlinkHref "#cw"] []
       , use [x "875", y "250", xlinkHref "#cw"] []

       , use [x "625", y "300", xlinkHref "#lv"] []
       , use [x "875", y "300", xlinkHref "#lv"] []
       , use [x "625", y "375", xlinkHref "#cw"] []
       , use [x "875", y "375", xlinkHref "#cw"] []

       , use [x "625", y "425", xlinkHref "#lv"] []
       , use [x "875", y "425", xlinkHref "#lv"] []
       , use [x "625", y "500", xlinkHref "#cw"] []
       , use [x "875", y "500", xlinkHref "#cw"] []

       , use [x "625", y "550", xlinkHref "#lv"] []
       , use [x "875", y "550", xlinkHref "#lv"] []
       , use [x "625", y "625", xlinkHref "#cw"] []
       , use [x "875", y "625", xlinkHref "#cw"] []
       , use [x "550", y "625", xlinkHref "#lh"] []
       , use [x "925", y "625", xlinkHref "#lh"] []
       , use [x "500", y "625", xlinkHref "#cw"] []
       , use [x "1000", y "625", xlinkHref "#cw"] []
       , use [x "425", y "625", xlinkHref "#lh"] []
       , use [x "1050", y "625", xlinkHref "#lh"] []
       , use [x "375", y "625", xlinkHref "#cw"] []
       , use [x "1125", y "625", xlinkHref "#cw"] []
       , use [x "300", y "625", xlinkHref "#lh"] []
       , use [x "1175", y "625", xlinkHref "#lh"] []
       , use [x "250", y "625", xlinkHref "#cw"] []
       , use [x "1250", y "625", xlinkHref "#cw"] []
       , use [x "175", y "625", xlinkHref "#lh"] []
       , use [x "1300", y "625", xlinkHref "#lh"] []
       , use [x "125", y "625", xlinkHref "#cy"] []
       , use [x "1375", y "625", xlinkHref "#cw"] []

       , use [x "125", y "675", xlinkHref "#lv"] []
       , use [x "1375", y "675", xlinkHref "#lv"] []
       , use [x "125", y "750", xlinkHref "#cw"] []
       , use [x "1375", y "750", xlinkHref "#cw"] []

       , use [x "125", y "800", xlinkHref "#lv"] []
       , use [x "1375", y "800", xlinkHref "#lv"] []
       , use [x "125", y "875", xlinkHref "#cw"] []
       , use [x "1375", y "875", xlinkHref "#cr"] []
       , use [x "250", y "875", xlinkHref "#cw"] []
       , use [x "1250", y "875", xlinkHref "#cw"] []
       , use [x "175", y "875", xlinkHref "#lh"] []
       , use [x "1300", y "875", xlinkHref "#lh"] []
       , use [x "375", y "875", xlinkHref "#cw"] []
       , use [x "1125", y "875", xlinkHref "#cw"] []
       , use [x "300", y "875", xlinkHref "#lh"] []
       , use [x "1175", y "875", xlinkHref "#lh"] []
       , use [x "500", y "875", xlinkHref "#cw"] []
       , use [x "1000", y "875", xlinkHref "#cw"] []
       , use [x "425", y "875", xlinkHref "#lh"] []
       , use [x "1050", y "875", xlinkHref "#lh"] []
       , use [x "625", y "875", xlinkHref "#cw"] []
       , use [x "875", y "875", xlinkHref "#cw"] []
       , use [x "550", y "875", xlinkHref "#lh"] []
       , use [x "925", y "875", xlinkHref "#lh"] []

       , use [x "625", y "925", xlinkHref "#lv"] []
       , use [x "875", y "925", xlinkHref "#lv"] []
       , use [x "625", y "1000", xlinkHref "#cw"] []
       , use [x "875", y "1000", xlinkHref "#cw"] []

       , use [x "625", y "1050", xlinkHref "#lv"] []
       , use [x "875", y "1050", xlinkHref "#lv"] []
       , use [x "625", y "1125", xlinkHref "#cw"] []
       , use [x "875", y "1125", xlinkHref "#cw"] []

       , use [x "625", y "1175", xlinkHref "#lv"] []
       , use [x "875", y "1175", xlinkHref "#lv"] []
       , use [x "625", y "1250", xlinkHref "#cw"] []
       , use [x "875", y "1250", xlinkHref "#cw"] []

       , use [x "625", y "1300", xlinkHref "#lv"] []
       , use [x "875", y "1300", xlinkHref "#lv"] []
       , use [x "625", y "1375", xlinkHref "#cb"] []
       , use [x "875", y "1375", xlinkHref "#cw"] []
       , use [x "675", y "1375", xlinkHref "#lh"] []
       , use [x "750", y "1375", xlinkHref "#cw"] []
       , use [x "800", y "1375", xlinkHref "#lh"] []

       , use [x "250", y "750", xlinkHref "#csy"] []
       , use [x "375", y "750", xlinkHref "#csy"] []
       , use [x "500", y "750", xlinkHref "#csy"] []
       , use [x "625", y "750", xlinkHref "#csy"] []

       , use [x "875", y "750", xlinkHref "#csr"] []
       , use [x "1000", y "750", xlinkHref "#csr"] []
       , use [x "1125", y "750", xlinkHref "#csr"] []
       , use [x "1250", y "750", xlinkHref "#csr"] []

       , use [x "750", y "250", xlinkHref "#csg"] []
       , use [x "750", y "375", xlinkHref "#csg"] []
       , use [x "750", y "500", xlinkHref "#csg"] []
       , use [x "750", y "625", xlinkHref "#csg"] []

       , use [x "750", y "875", xlinkHref "#csb"] []
       , use [x "750", y "1000", xlinkHref "#csb"] []
       , use [x "750", y "1125", xlinkHref "#csb"] []
       , use [x "750", y "1250", xlinkHref "#csb"] []

       , use [x "125", y "125", xlinkHref "#csy"] []
       , use [x "250", y "125", xlinkHref "#csy"] []
       , use [x "125", y "250", xlinkHref "#csy"] []
       , use [x "250", y "250", xlinkHref "#csy"] []

       , use [x "1375", y "125", xlinkHref "#csg"] []
       , use [x "1250", y "125", xlinkHref "#csg"] []
       , use [x "1250", y "250", xlinkHref "#csg"] []
       , use [x "1375", y "250", xlinkHref "#csg"] []

       , use [x "125", y "1250", xlinkHref "#csb"] []
       , use [x "250", y "1250", xlinkHref "#csb"] []
       , use [x "125", y "1375", xlinkHref "#csb"] []
       , use [x "250", y "1375", xlinkHref "#csb"] []

       , use [x "1375", y "1250", xlinkHref "#csr"] []
       , use [x "1250", y "1250", xlinkHref "#csr"] []
       , use [x "1250", y "1375", xlinkHref "#csr"] []
       , use [x "1375", y "1375", xlinkHref "#csr"] []
      ...
      , circle [cy "30", cy "30", r (toString radius), stroke "red", strokeWidth "4", fill "blue", onClick Enlarge] []
      ]
